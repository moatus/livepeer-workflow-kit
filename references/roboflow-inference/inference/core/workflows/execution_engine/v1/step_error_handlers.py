...
try:
    ...
    class ModelPackageAlternativesExhaustedError(Exception):
        alternatives_errors = None

    class ModelPackageRestrictedError(Exception):
        pass

    class UnauthorizedModelAccessError(Exception):
        pass
