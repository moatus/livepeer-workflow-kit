...
WORKFLOWS_PLUGIN_ONLY_CORE_ENV = "WORKFLOWS_PLUGIN_ONLY_CORE"
WORKFLOWS_PLUGIN_ONLY_CORE = os.environ.get(
    WORKFLOWS_PLUGIN_ONLY_CORE_ENV, ""
).lower() in {"1", "true", "yes"}

if WORKFLOWS_PLUGIN_ONLY_CORE:
    KINDS_DESERIALIZERS = {}
    KINDS_SERIALIZERS = {}
